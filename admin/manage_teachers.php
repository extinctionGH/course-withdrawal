...
<div class="card">
    ...
    <?php if ($teachers): ?>
                            ...
                            <form method="POST">
                                <td>
                                    <div style="display: flex; align-items: center; gap: 8px;">
                                        <?php if ($t['UserID'] == $_SESSION['userID']): ?>
                                            <span
                                                style="background: #5bc0be; color: #0b132b; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 600;">YOU</span>
                                        <?php endif; ?>
                                        <input type="text" name="full_name" value="<?= htmlspecialchars($t['FullName']) ?>"
                                            required>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    if ($studentCount > 0):
                                        ?>
                                        <span
                                            style="display: inline-flex; align-items: center; gap: 5px; background: rgba(91, 192, 190, 0.15); padding: 4px 12px; border-radius: 6px; color: #5bc0be; font-weight: 600;">
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <button type="button" class="btn" style="background: #6b7b8c; cursor: not-allowed;" disabled
        ...
        <!-- Summary Footer -->
        <div
            style="margin-top: 20px; padding: 15px; background: #0f1a35; border-radius: 8px; display: flex; justify-content: space-between; align-items: center;">
